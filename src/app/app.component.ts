...
export class AppComponent implements OnInit, OnDestroy {
  ...
  constructor(changeDetectorRef: ChangeDetectorRef, media: MediaMatcher, webStorageService: WebStorageService, loginDialog: MatDialog,
    ...
    this.matIconRegistry.addSvgIcon('facebook',
                                    this.domSanitizer.bypassSecurityTrustResourceUrl(constants.assetsUrl + 'facebook.svg'));
    this.matIconRegistry.addSvgIcon('google-plus',
                                    this.domSanitizer.bypassSecurityTrustResourceUrl(constants.assetsUrl + 'google-plus.svg'));
    this.matIconRegistry.addSvgIcon('air_conditioner',
                                    this.domSanitizer.bypassSecurityTrustResourceUrl(constants.assetsUrl + 'air-conditioner.svg'));
    ...
    this.matIconRegistry.addSvgIcon('keyboard_arrow_left',
                                    this.domSanitizer.bypassSecurityTrustResourceUrl(constants.assetsUrl + 'keyboard_arrow_left-24px.svg'));
    this.matIconRegistry.addSvgIcon('keyboard_arrow_right',
                                    this.domSanitizer.bypassSecurityTrustResourceUrl(constants.assetsUrl +
                                                                                      'keyboard_arrow_right-24px.svg'));
    this.matIconRegistry.addSvgIcon('keyboard_arrow_up',
                                    this.domSanitizer.bypassSecurityTrustResourceUrl(constants.assetsUrl + 'keyboard_arrow_up-24px.svg'));
    this.matIconRegistry.addSvgIcon('keyboard_arrow_down',
                                    this.domSanitizer.bypassSecurityTrustResourceUrl(constants.assetsUrl + 'keyboard_arrow_down-24px.svg'));
