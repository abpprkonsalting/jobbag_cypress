...
export class HttpTokenInterceptor implements HttpInterceptor {
  intercept(
    ...
    next: HttpHandler
      ...
      const sessionToken: SessionToken = this.webStorageService.getSessionToken();
      if ((request.url.startsWith(constants.apiUrl) || request.url.startsWith('api')) &&
          (sessionToken !== undefined && sessionToken.jwtAuth)) {
